...
public class Vaccine extends GameObject {
    ...
    public Vaccine(float VELOCITY, int movingVectorX, int movingVectorY, int hp, Bitmap image, int width, int height, int x, int y,GameSurface gameSurface) {
    ...
    public void update() {
        ...
        // Khi vaccine của game chạm ra khỏi màn hình thì đợi
